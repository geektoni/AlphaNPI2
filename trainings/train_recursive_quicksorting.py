from environments.recursive_list_env import QuickSortRecursiveListEnv, RecursiveListEnvEncoder
...
if __name__ == "__main__":
    ...
    env_tmp = QuickSortRecursiveListEnv(length=5, encoding_dim=conf.encoding_dim)
    ...
    for iteration in range(conf.num_iterations):
        ...
        env = QuickSortRecursiveListEnv(length=length, encoding_dim=conf.encoding_dim)
        trainer.env = env
